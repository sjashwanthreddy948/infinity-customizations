      ...
      <div className="p-4 rounded-2xl bg-white dark:bg-[#082A5E] border border-slate-200 dark:border-blue-900/50 shadow-card flex flex-col md:flex-row items-center gap-3">
        ...
        <div className="grid grid-cols-2 sm:flex sm:items-center gap-2 w-full md:w-auto">
          <select
            ...
            className="w-full sm:w-auto px-2.5 sm:px-3 py-2 text-xs rounded-xl border border-slate-300 bg-white text-slate-900 font-semibold"
          >
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <span className="text-[11px] text-slate-600 block font-medium">{o.order_date}</span>
                </div>
              ...
              <div className="border-t border-slate-100 pt-2 flex items-start justify-between gap-2">
                <div>
                  ...
                  <p className="text-[11px] text-slate-600 font-medium">{o.customer_phone}</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                <div className="p-2 rounded-xl bg-slate-50 border border-slate-200">
                  <span className="text-[9px] uppercase font-bold text-slate-600 block">Customer Total</span>
                  <span className="text-xs font-black text-slate-900">₹{o.selling_price?.toLocaleString('en-IN')}</span>
                </div>
                <div className="p-2 rounded-xl bg-slate-50 border border-slate-200">
                  <span className="text-[9px] uppercase font-bold text-slate-600 block">Total Cost</span>
                ...
                <div className="p-2 rounded-xl bg-amber-50/60 border border-[#D4AF37]/40">
                  <span className="text-[9px] uppercase font-bold text-amber-900 block">Net Profit</span>
                  <span className="text-xs font-black text-[#9A7B1C]">₹{o.profit?.toLocaleString('en-IN')}</span>
                </div>
                <div className="p-2 rounded-xl bg-slate-50 border border-slate-200">
                  <span className="text-[9px] uppercase font-bold text-slate-600 block">Available Cash</span>
              ...
              <div className="border-t border-slate-100 pt-2 flex items-center justify-between text-[11px] text-slate-600 font-medium">
