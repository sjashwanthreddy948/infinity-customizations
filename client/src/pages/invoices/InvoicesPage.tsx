                ...
                <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                  {inv.balance_due > 0 && inv.status !== 'VOID' && (
                    <button
                      ...
                      className="px-2.5 py-1 text-[11px] font-bold rounded-lg bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100"
                    >
                      Pay
                    </button>
                  )}
                  <button
                    onClick={() => navigate(`/invoices/${inv.id}`)}
                    className="px-2.5 py-1 text-[11px] font-bold rounded-lg bg-[#0B3A82] text-white hover:bg-[#082A5E]"
                  >
                    View
                  </button>
                </div>
