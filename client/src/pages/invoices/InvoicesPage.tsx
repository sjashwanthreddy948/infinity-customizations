                ...
                <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                  {inv.balance_due > 0 && inv.status !== 'VOID' && (
                    <button
                      ...
                      className="px-2.5 py-1 text-[11px] font-bold rounded-lg bg-emerald-50 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100"
                    >
                      Pay
                    </button>
                  )}
